...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ErrorResponse> handleAccessDeniedException(AccessDeniedException ex) {
        ...
        return createErrorResponseEntity(HttpStatus.FORBIDDEN, "ACCESS_DENIED", "[OOTDay] 토큰이 유효하지 않거나 사용자에게 해당 접근 권한이 없습니다.");
    }
    ...
    public ResponseEntity<ErrorResponse> handleMalformedJwtException(MalformedJwtException ex) {
        ...
        return createErrorResponseEntity(HttpStatus.UNAUTHORIZED, "WRONG_SIGNATURE_TOKEN", "[OOTDay] JWT 토큰이 변조되었거나 잘못된 형식입니다");
    }
